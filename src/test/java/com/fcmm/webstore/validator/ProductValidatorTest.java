...
public class ProductValidatorTest {
  ...
  public void product_without_UnitPrice_should_be_invalid() {
    ...
    Assert.assertTrue(bindException.getLocalizedMessage().contains("Le prix unitaire est obligatoire."));
  }
  ...
  public void product_with_existing_productId_invalid() {
    ...
    //Assert
    Assert.assertEquals(1, bindException.getErrorCount()); 
    Assert.assertTrue(bindException.getLocalizedMessage().contains("Il existe déjà un autre produit avec cet identifiant."));
  }
